        ...
        <form id="kc-register-form" class="${properties.kcFormClass!}" action="${url.registrationAction}" method="post">
            ...
            <#if passwordRequired??>
                ...
                <div class="${properties.kcFormGroupClass!}">
                    ...
                    <div class="${properties.kcInputWrapperClass!}">
                        <input type="password" id="password-confirm" placeholder="Confirm Password" class="${properties.kcInputClass!}"
            ...
            <div class="back ${properties.kcFormGroupClass!}">
                <div id="kc-form-options" class="back ${properties.kcFormOptionsClass!}">
                    <div class="back ${properties.kcFormOptionsWrapperClass!}">
                        <span><a class="a-link" href="${url.loginUrl}">${kcSanitize(msg("backToLogin"))?no_esc}</a></span>
                    </div>
                </div>

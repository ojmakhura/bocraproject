  ...
  function ($routeProvider) {
    $routeProvider
      ...
      .when("/realms/:realm/clients/:client/authz/resource-server/create", {
        templateUrl:
          resourceUrl + "/partials/authz/resource-server-detail.html",
        resolve: {
          realm: function (RealmLoader) {
            return RealmLoader();
          },
      ...
      .when(
        "/realms/:realm/clients/:client/authz/resource-server/export-settings",
        {
          templateUrl:
            resourceUrl +
            "/partials/authz/resource-server-export-settings.html",
          resolve: {
            realm: function (RealmLoader) {
              return RealmLoader();
            },
      ...
      .when("/realms/:realm/clients/:client/authz/resource-server/evaluate", {
        templateUrl:
          resourceUrl +
          "/partials/authz/policy/resource-server-policy-evaluate.html",
        resolve: {
          realm: function (RealmLoader) {
            return RealmLoader();
          },
      ...
      .when(
        "/realms/:realm/clients/:client/authz/resource-server/evaluate/result",
        {
          templateUrl:
            resourceUrl +
            "/partials/authz/policy/resource-server-policy-evaluate-result.html",
          resolve: {
            realm: function (RealmLoader) {
              return RealmLoader();
            },
      ...
      .when("/realms/:realm/clients/:client/authz/resource-server/resource", {
        templateUrl:
          resourceUrl + "/partials/authz/resource-server-resource-list.html",
        resolve: {
          realm: function (RealmLoader) {
            return RealmLoader();
          },
      ...
      .when(
        "/realms/:realm/clients/:client/authz/resource-server/resource/create",
        {
          templateUrl:
            resourceUrl +
            "/partials/authz/resource-server-resource-detail.html",
          resolve: {
            realm: function (RealmLoader) {
              return RealmLoader();
            },
      ...
      .when("/realms/:realm/clients/:client/authz/resource-server/scope", {
        templateUrl:
          resourceUrl + "/partials/authz/resource-server-scope-list.html",
        resolve: {
          realm: function (RealmLoader) {
            return RealmLoader();
          },
      ...
      .when(
        ...
        {
          templateUrl:
            resourceUrl + "/partials/authz/resource-server-scope-detail.html",
          resolve: {
            realm: function (RealmLoader) {
              return RealmLoader();
            },
      ...
      .when("/realms/:realm/clients/:client/authz/resource-server/permission", {
        templateUrl:
          resourceUrl +
          "/partials/authz/permission/resource-server-permission-list.html",
        resolve: {
          realm: function (RealmLoader) {
            return RealmLoader();
          },
      ...
      .when("/realms/:realm/clients/:client/authz/resource-server/policy", {
        templateUrl:
          resourceUrl +
          "/partials/authz/policy/resource-server-policy-list.html",
        resolve: {
          realm: function (RealmLoader) {
            return RealmLoader();
          },
      ...
      .when(
        "/realms/:realm/clients/:client/authz/resource-server/permission/resource/create",
        {
          templateUrl:
            resourceUrl +
            "/partials/authz/permission/provider/resource-server-policy-resource-detail.html",
          resolve: {
            realm: function (RealmLoader) {
              return RealmLoader();
            },
      ...
      .when(
        "/realms/:realm/clients/:client/authz/resource-server/permission/scope/create",
        {
          templateUrl:
            resourceUrl +
            "/partials/authz/permission/provider/resource-server-policy-scope-detail.html",
          resolve: {
            realm: function (RealmLoader) {
              return RealmLoader();
            },
      ...
      .when(
        "/realms/:realm/clients/:client/authz/resource-server/policy/user/create",
        {
          templateUrl:
            resourceUrl +
            "/partials/authz/policy/provider/resource-server-policy-user-detail.html",
          resolve: {
            realm: function (RealmLoader) {
              return RealmLoader();
            },
      ...
      .when(
        "/realms/:realm/clients/:client/authz/resource-server/policy/client/create",
        {
          templateUrl:
            resourceUrl +
            "/partials/authz/policy/provider/resource-server-policy-client-detail.html",
          resolve: {
            realm: function (RealmLoader) {
              return RealmLoader();
            },
      ...
      .when(
        "/realms/:realm/clients/:client/authz/resource-server/policy/role/create",
        {
          templateUrl:
            resourceUrl +
            "/partials/authz/policy/provider/resource-server-policy-role-detail.html",
          resolve: {
            realm: function (RealmLoader) {
              return RealmLoader();
            },
      ...
      .when(
        "/realms/:realm/clients/:client/authz/resource-server/policy/group/create",
        {
          templateUrl:
            resourceUrl +
            "/partials/authz/policy/provider/resource-server-policy-group-detail.html",
          resolve: {
            realm: function (RealmLoader) {
              return RealmLoader();
            },
      ...
      .when(
        "/realms/:realm/clients/:client/authz/resource-server/policy/js/create",
        {
          templateUrl:
            resourceUrl +
            "/partials/authz/policy/provider/resource-server-policy-js-detail.html",
          resolve: {
            realm: function (RealmLoader) {
              return RealmLoader();
            },
      ...
      .when(
        "/realms/:realm/clients/:client/authz/resource-server/policy/time/create",
        {
          templateUrl:
            resourceUrl +
            "/partials/authz/policy/provider/resource-server-policy-time-detail.html",
          resolve: {
            realm: function (RealmLoader) {
              return RealmLoader();
            },
      ...
      .when(
        "/realms/:realm/clients/:client/authz/resource-server/policy/aggregate/create",
        {
          templateUrl:
            resourceUrl +
            "/partials/authz/policy/provider/resource-server-policy-aggregate-detail.html",
          resolve: {
            realm: function (RealmLoader) {
              return RealmLoader();
            },
      ...
      .when("/realms/:realm/roles/:role/permissions", {
        templateUrl:
          resourceUrl + "/partials/authz/mgmt/realm-role-permissions.html",
        resolve: {
          realm: function (RealmLoader) {
            return RealmLoader();
          },
      ...
      .when("/realms/:realm/clients/:client/roles/:role/permissions", {
        templateUrl:
          resourceUrl + "/partials/authz/mgmt/client-role-permissions.html",
        resolve: {
          realm: function (RealmLoader) {
            return RealmLoader();
          },
      ...
      .when("/realms/:realm/users-permissions", {
        templateUrl:
          resourceUrl + "/partials/authz/mgmt/users-permissions.html",
        resolve: {
          realm: function (RealmLoader) {
            return RealmLoader();
          },
      ...
      .when("/realms/:realm/clients/:client/permissions", {
        templateUrl:
          resourceUrl + "/partials/authz/mgmt/client-permissions.html",
        resolve: {
          realm: function (RealmLoader) {
            return RealmLoader();
          },
      ...
      .when("/realms/:realm/groups/:group/permissions", {
        templateUrl:
          resourceUrl + "/partials/authz/mgmt/group-permissions.html",
        resolve: {
          realm: function (RealmLoader) {
            return RealmLoader();
          },
      ...
      .when(
        "/realms/:realm/identity-provider-settings/provider/:provider_id/:alias/permissions",
        {
          templateUrl: function (params) {
            return resourceUrl + "/partials/authz/mgmt/broker-permissions.html";
          },
          resolve: {
            realm: function (RealmLoader) {
              return RealmLoader();

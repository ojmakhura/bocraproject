module.controller(
  "ResourceServerCtrl",
  function ($scope, realm, ResourceServer) {
    $scope.realm = realm;
      ...
      function (dependentPolicies) {
        if (dependentPolicies.length > 0 && !$scope.deleteConsent) {
          ...
          for (i = 0; i < dependentPolicies.length; i++) {
            msg +=
              "<li><strong>" + dependentPolicies[i].name + "</strong></li>";
          }
          msg += "</ul>";
          msg +=
          ...
          $location
            .path(
              "/realms/" +
                ...
                "/clients/" +
                client.id +
                "/authz/resource-server/permission/resource/create"
            )
          ...
          $location
            .path(
              "/realms/" +
                ...
                "/clients/" +
                client.id +
                "/authz/resource-server/permission/scope/create"
            )
...
module.controller(
  ...
  function ($scope, $route, realm, client, PolicyController, User) {
    PolicyController.onInit(
      {
        getPolicyType: function () {
          return "user";
...
module.controller(
  ...
  function ($scope, $route, realm, client, PolicyController, Client) {
    PolicyController.onInit(
      {
        getPolicyType: function () {
          return "client";
...
module.controller(
  ...
  function ($scope, $route, $location, realm, PolicyController, client) {

...
module.factory(
  ...
  function (Loader, RealmSpecificLocales, $route, $q) {
...
module.factory(
  ...
  function (Loader, RealmSpecificLocalizationText, $route, $q) {
...
module.factory(
  ...
  function (Loader, RealmEventsConfig, $route, $q) {
...
module.factory(
  ...
  function (Loader, RequiredActions, $route, $q) {
...
module.factory(
  ...
  function (Loader, UnregisteredRequiredActions, $route, $q) {
...
module.factory(
  ...
  function (Loader, RealmSessionStats, $route, $q) {
...
module.factory(
  ...
  function (Loader, RealmClientSessionStats, $route, $q) {
...
module.factory(
  ...
  function (Loader, ClientProtocolMapper, $route, $q) {
...
module.factory(
  ...
  function (Loader, ClientScopeProtocolMapper, $route, $q) {
...
module.factory(
  ...
  function (Loader, SubComponentTypes, $route, $q) {
    var componentsLoader = {};
...
module.factory(
  ...
  function (Loader, UserSessionStats, $route, $q) {
...
module.factory(
  "UserSessionsLoader",
  function (Loader, UserSessions, $route, $q) {
...
module.factory(
  ...
  function (Loader, UserOfflineSessions, $route, $q) {
...
module.factory(
  ...
  function (Loader, UserFederatedIdentities, $route, $q) {
...
module.factory(
  "UserConsentsLoader",
  function (Loader, UserConsents, $route, $q) {
...
module.factory(
  ...
  function (Loader, ClientSessionStats, $route, $q) {
...
module.factory(
  ...
  function (Loader, ClientSessionCount, $route, $q) {
...
module.factory(
  ...
  function (Loader, ClientOfflineSessionCount, $route, $q) {
...
module.factory(
  ...
  function (Loader, ClientDefaultClientScopes, $route, $q) {
...
module.factory(
  ...
  function (Loader, ClientOptionalClientScopes, $route, $q) {
...
module.factory(
  "ClientScopeListLoader",
  function (Loader, ClientScope, $route, $q) {
...
module.factory(
  ...
  function (Loader, RealmDefaultClientScopes, $route, $q) {
...
module.factory(
  ...
  function (Loader, RealmOptionalClientScopes, $route, $q) {
...
module.factory(
  ...
  function (Loader, ClientServiceAccountUser, $route, $q) {
...
module.factory(
  ...
  function (Loader, IdentityProvider, $route, $q) {
...
module.factory(
  ...
  function (Loader, IdentityProviderFactory, $route, $q) {
...
module.factory(
  ...
  function (Loader, IdentityProviderMapperTypes, $route, $q) {
...
module.factory(
  ...
  function (Loader, IdentityProviderMappers, $route, $q) {
...
module.factory(
  ...
  function (Loader, IdentityProviderMapper, $route, $q) {
...
module.factory(
  ...
  function (Loader, AuthenticationFlows, $route, $q) {
...
module.factory(
  ...
  function (Loader, AuthenticationFormProviders, $route, $q) {
...
module.factory(
  ...
  function (Loader, AuthenticationFormActionProviders, $route, $q) {
...
module.factory(
  ...
  function (Loader, AuthenticatorProviders, $route, $q) {
...
module.factory(
  ...
  function (Loader, ClientAuthenticatorProviders, $route, $q) {
...
module.factory(
  ...
  function (Loader, AuthenticationConfigDescription, $route, $q) {
...
module.factory(
  ...
  function (Loader, PerClientAuthenticationConfigDescription, $route, $q) {
...
module.factory("ExecutionIdLoader", function ($route) {
  return function () {
    return $route.current.params.executionId;
  };
});

module.factory(
  "AuthenticationConfigLoader",
  function (Loader, AuthenticationConfig, $route, $q) {
...
module.factory(
  ...
  function (Loader, ClientInitialAccess, $route) {

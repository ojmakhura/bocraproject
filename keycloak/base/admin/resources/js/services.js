...
module.service("Dialog", function ($modal, $translate) {
  ...
  dialog.confirmGenerateKeys = function (name, type, success) {
    ...
    var msg =
      "Are you sure you want to permanently generate new keys for " +
      name +
      "?";
    var btns = {
      ok: {
  ...
  dialog.confirmWithButtonText = function (
    title,
    message,
    confirm,
    success,
...
module.factory("ComponentUtils", function () {
  ...
  utils.convertAllMultivaluedStringValuesToList = function (
    properties,
    config
  ) {
    if (!properties) {
  ...
  utils.convertAllListValuesToMultivaluedString = function (
    properties,
    config
  ) {
    if (!properties) {
...
module.factory("ClientInitialAccess", function ($resource) {
  return $resource(
    authUrl + "/admin/realms/:realm/clients-initial-access/:id",
    {
      realm: "@realm",
      id: "@id",
    }
...
module.factory("ClientProtocolMapper", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/clients/:client/protocol-mappers/models/:id",
    {
      realm: "@realm",
      client: "@client",
      id: "@id",
...
module.factory("ClientScopeProtocolMapper", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/client-scopes/:clientScope/protocol-mappers/models/:id",
    {
      realm: "@realm",
...
module.factory("UserFederatedIdentities", function ($resource) {
  return $resource(
    authUrl + "/admin/realms/:realm/users/:user/federated-identity",
    {
      realm: "@realm",
      user: "@user",
    }
...
module.factory("UserConsents", function ($resource) {
  return $resource(
    authUrl + "/admin/realms/:realm/users/:user/consents/:client",
    {
      realm: "@realm",
      user: "@user",
      client: "@client",
...
module.factory("UserCredentials", function ($resource) {
  ...
  credentials.getConfiguredUserStorageCredentialTypes = $resource(
    authUrl +
      "/admin/realms/:realm/users/:userId/configured-user-storage-credential-types",
    {
      realm: "@realm",
      userId: "@userId",
    }
  ...
  credentials.updateCredentialLabel = $resource(
    authUrl +
      "/admin/realms/:realm/users/:userId/credentials/:credentialId/userLabel",
    {
      realm: "@realm",
      userId: "@userId",
      credentialId: "@credentialId",
  ...
  credentials.moveCredentialAfter = $resource(
    authUrl +
      "/admin/realms/:realm/users/:userId/credentials/:credentialId/moveAfter/:newPreviousCredentialId",
    {
      realm: "@realm",
      userId: "@userId",
      credentialId: "@credentialId",
  ...
  credentials.moveToFirst = $resource(
    authUrl +
      "/admin/realms/:realm/users/:userId/credentials/:credentialId/moveToFirst",
    {
      realm: "@realm",
      userId: "@userId",
      credentialId: "@credentialId",
...
module.factory("CompositeClientRoleMapping", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/users/:userId/role-mappings/clients/:client/composite",
    {
      realm: "@realm",
      userId: "@userId",
      client: "@client",
...
module.factory("ClientAvailableRealmScopeMapping", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/clients/:client/scope-mappings/realm/available",
    {
      realm: "@realm",
      client: "@client",
    }
...
module.factory("ClientCompositeRealmScopeMapping", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/clients/:client/scope-mappings/realm/composite",
    {
      realm: "@realm",
      client: "@client",
    }
...
module.factory("ClientClientScopeMapping", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/clients/:client/scope-mappings/clients/:targetClient",
    {
      realm: "@realm",
      client: "@client",
...
module.factory("ClientAvailableClientScopeMapping", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/clients/:client/scope-mappings/clients/:targetClient/available",
    {
      realm: "@realm",
      client: "@client",
      targetClient: "@targetClient",
...
module.factory("ClientCompositeClientScopeMapping", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/clients/:client/scope-mappings/clients/:targetClient/composite",
    {
      realm: "@realm",
      client: "@client",
      targetClient: "@targetClient",
...
module.factory("RoleClientComposites", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/roles-by-id/:role/composites/clients/:client",
    {
      realm: "@realm",
      role: "@role",
      client: "@client",
...
module.factory("ClientDefaultClientScopes", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/clients/:client/default-client-scopes/:clientScopeId",
    {
      realm: "@realm",
      client: "@client",
...
module.factory("ClientOptionalClientScopes", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/clients/:client/optional-client-scopes/:clientScopeId",
    {
      realm: "@realm",
      client: "@client",
      clientScopeId: "@clientScopeId",
...
module.factory("ClientEvaluateProtocolMappers", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/clients/:client/evaluate-scopes/protocol-mappers?scope=:scopeParam",
    {
      realm: "@realm",
      client: "@client",
...
module.factory("ClientEvaluateGrantedRoles", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/clients/:client/evaluate-scopes/scope-mappings/:roleContainer/granted?scope=:scopeParam",
    {
      realm: "@realm",
      client: "@client",
...
module.factory("ClientEvaluateNotGrantedRoles", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/clients/:client/evaluate-scopes/scope-mappings/:roleContainer/not-granted?scope=:scopeParam",
    {
      realm: "@realm",
      client: "@client",
      roleContainer: "@roleContainer",
...
module.factory("ClientEvaluateGenerateExampleToken", function ($resource) {
  var url =
    authUrl +
    "/admin/realms/:realm/clients/:client/evaluate-scopes/generate-example-access-token?scope=:scopeParam&userId=:userId";
  return {
...
module.factory("ClientProtocolMappersByProtocol", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/clients/:client/protocol-mappers/protocol/:protocol",
    {
      realm: "@realm",
      client: "@client",
      protocol: "@protocol",
...
module.factory("ClientScopeProtocolMappersByProtocol", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/client-scopes/:clientScope/protocol-mappers/protocol/:protocol",
    {
      realm: "@realm",
      clientScope: "@clientScope",
      protocol: "@protocol",
...
module.factory("ClientScopeRealmScopeMapping", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/client-scopes/:clientScope/scope-mappings/realm",
    {
      realm: "@realm",
      clientScope: "@clientScope",
    }
...
module.factory("ClientScopeAvailableRealmScopeMapping", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/client-scopes/:clientScope/scope-mappings/realm/available",
    {
      realm: "@realm",
      clientScope: "@clientScope",
    }
...
module.factory("ClientScopeCompositeRealmScopeMapping", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/client-scopes/:clientScope/scope-mappings/realm/composite",
    {
      realm: "@realm",
      clientScope: "@clientScope",
    }
...
module.factory("ClientScopeClientScopeMapping", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/client-scopes/:clientScope/scope-mappings/clients/:targetClient",
    {
      realm: "@realm",
      clientScope: "@clientScope",
      targetClient: "@targetClient",
...
module.factory("ClientScopeAvailableClientScopeMapping", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/client-scopes/:clientScope/scope-mappings/clients/:targetClient/available",
    {
      realm: "@realm",
      clientScope: "@clientScope",
      targetClient: "@targetClient",
...
module.factory("ClientScopeCompositeClientScopeMapping", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/client-scopes/:clientScope/scope-mappings/clients/:targetClient/composite",
    {
      realm: "@realm",
      clientScope: "@clientScope",
      targetClient: "@targetClient",
...
module.factory("ClientSessionStats", function ($resource) {
  return $resource(
    authUrl + "/admin/realms/:realm/clients/:client/session-stats",
    {
      realm: "@realm",
      client: "@client",
    }
...
module.factory("ClientSessionCount", function ($resource) {
  return $resource(
    authUrl + "/admin/realms/:realm/clients/:client/session-count",
    {
      realm: "@realm",
      client: "@client",
    }
...
module.factory("ClientUserSessions", function ($resource) {
  return $resource(
    authUrl + "/admin/realms/:realm/clients/:client/user-sessions",
    {
      realm: "@realm",
      client: "@client",
    }
...
module.factory("ClientOfflineSessions", function ($resource) {
  return $resource(
    authUrl + "/admin/realms/:realm/clients/:client/offline-sessions",
    {
      realm: "@realm",
      client: "@client",
    }
...
module.factory("ClientPushRevocation", function ($resource) {
  return $resource(
    authUrl + "/admin/realms/:realm/clients/:client/push-revocation",
    {
      realm: "@realm",
      client: "@client",
    }
...
module.factory("ClientClusterNode", function ($resource) {
  return $resource(
    authUrl + "/admin/realms/:realm/clients/:client/nodes/:node",
    {
      realm: "@realm",
      client: "@client",
    }
...
module.factory("ClientCertificateGenerate", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/clients/:client/certificates/:attribute/generate",
    {
      realm: "@realm",
      client: "@client",
      attribute: "@attribute",
...
module.factory("ClientCertificateDownload", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/clients/:client/certificates/:attribute/download",
    {
      realm: "@realm",
      client: "@client",
      attribute: "@attribute",
...
module.factory("ClientDescriptionConverter", function ($resource) {
  return $resource(
    authUrl + "/admin/realms/:realm/client-description-converter",
    {
      realm: "@realm",
    }
  );
...
module.factory("ClientInstallation", function ($resource) {
  var url =
    authUrl +
    "/admin/realms/:realm/clients/:client/installation/providers/:provider";
  return {
    url: function (parameters) {
      return url
        .replace(":realm", parameters.realm)
...
module.factory("IdentityProviderExport", function ($resource) {
  var url =
    authUrl + "/admin/realms/:realm/identity-provider/instances/:alias/export";
  return {
    url: function (parameters) {
      return url
        .replace(":realm", parameters.realm)
...
module.factory("IdentityProviderMapper", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/identity-provider/instances/:alias/mappers/:mapperId",
    {
      realm: "@realm",
      alias: "@alias",
      mapperId: "@mapperId",
...
module.factory("CreateExecutionFlow", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/authentication/flows/:alias/executions/flow",
    {
      realm: "@realm",
      alias: "@alias",
    }
...
module.factory("CreateExecution", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/authentication/flows/:alias/executions/execution",
    {
      realm: "@realm",
      alias: "@alias",
    }
...
module.factory("AuthenticationFormProviders", function ($resource) {
  return $resource(
    authUrl + "/admin/realms/:realm/authentication/form-providers",
    {
      realm: "@realm",
    }
  );
...
module.factory("AuthenticationFlowsCopy", function ($resource) {
  return $resource(
    authUrl + "/admin/realms/:realm/authentication/flows/:alias/copy",
    {
      realm: "@realm",
      alias: "@alias",
    }
...
module.factory("AuthenticationConfigDescription", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/authentication/config-description/:provider",
    {
      realm: "@realm",
      provider: "@provider",
    }
...
module.factory(
  "PerClientAuthenticationConfigDescription",
  function ($resource) {
    return $resource(
      authUrl +
...
module.factory("AuthenticationExecutionRaisePriority", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/authentication/executions/:execution/raise-priority",
    {
      realm: "@realm",
      execution: "@execution",
    }
...
module.factory("AuthenticationExecutionLowerPriority", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/authentication/executions/:execution/lower-priority",
    {
      realm: "@realm",
      execution: "@execution",
    }
...
module.service("SelectRoleDialog", function ($modal) {
  ...
  dialog.confirmDelete = function (name, type, success) {
    var title =
      "Delete " + escapeHtml(type.charAt(0).toUpperCase() + type.slice(1));
    var msg =
...
module.factory("GroupCompositeRealmRoleMapping", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/groups/:groupId/role-mappings/realm/composite",
    {
      realm: "@realm",
      groupId: "@groupId",
    }
...
module.factory("GroupAvailableRealmRoleMapping", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/groups/:groupId/role-mappings/realm/available",
    {
      realm: "@realm",
      groupId: "@groupId",
    }
...
module.factory("GroupClientRoleMapping", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/groups/:groupId/role-mappings/clients/:client",
    {
      realm: "@realm",
      groupId: "@groupId",
      client: "@client",
...
module.factory("GroupAvailableClientRoleMapping", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/groups/:groupId/role-mappings/clients/:client/available",
    {
      realm: "@realm",
      groupId: "@groupId",
      client: "@client",
...
module.factory("GroupCompositeClientRoleMapping", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/groups/:groupId/role-mappings/clients/:client/composite",
    {
      realm: "@realm",
      groupId: "@groupId",
      client: "@client",
...
module.factory("SubComponentTypes", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/components/:componentId/sub-component-types",
    {
      realm: "@realm",
...
module.factory("UserStorageOperations", function ($resource) {
  ...
  object.removeImportedUsers = $resource(
    authUrl +
      "/admin/realms/:realm/user-storage/:componentId/remove-imported-users",
    {
      realm: "@realm",
      componentId: "@componentId",
    }
...
module.factory("LDAPMapperSync", function ($resource) {
  return $resource(
    authUrl +
      "/admin/realms/:realm/user-storage/:parentId/mappers/:mapperId/sync",
    {
      realm: "@realm",
      componentId: "@componentId",
      mapperId: "@mapperId",

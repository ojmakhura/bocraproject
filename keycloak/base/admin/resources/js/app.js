  ...
  function ($routeProvider) {
    $routeProvider
      ...
      .when("/realms/:realm/client-registration/client-initial-access/create", {
        templateUrl:
          resourceUrl + "/partials/client-initial-access-create.html",
        resolve: {
          realm: function (RealmLoader) {
            return RealmLoader();
          },
      ...
      .when("/realms/:realm/client-registration/client-reg-policies", {
        ...
        resolve: {
          ...
          policies: function (ComponentsLoader) {
            return ComponentsLoader.loadComponents(
              null,
              "org.keycloak.services.clientregistration.policy.ClientRegistrationPolicy"
            );
          },
          clientRegistrationPolicyProviders: function (
      ...
      .when("/create/identity-provider/:realm/:provider_id", {
        templateUrl: function (params) {
          return (
            resourceUrl +
            "/partials/realm-identity-provider-" +
            params.provider_id +
            ".html"
          );
        },
      ...
      .when(
        ...
        {
          templateUrl:
            resourceUrl + "/partials/realm-identity-provider-export.html",
          resolve: {
            realm: function (RealmLoader) {
              return RealmLoader();
            },
      ...
      .when("/realms/:realm/users/:user/federated-identity", {
        templateUrl:
          resourceUrl + "/partials/user-federated-identity-list.html",
        resolve: {
          realm: function (RealmLoader) {
            return RealmLoader();
          },
      ...
      .when("/create/federated-identity/:realm/:user", {
        templateUrl:
          resourceUrl + "/partials/user-federated-identity-detail.html",
        resolve: {
          realm: function (RealmLoader) {
            return RealmLoader();
          },
      ...
      .when("/realms/:realm/clients/:client/mappers/:id", {
        templateUrl:
          resourceUrl + "/partials/client-protocol-mapper-detail.html",
        resolve: {
          realm: function (RealmLoader) {
            return RealmLoader();
          },
      ...
      .when("/realms/:realm/clients/:client/client-scopes/setup-scopes", {
        ...
        resolve: {
          ...
          clientDefaultClientScopes: function (
            ClientDefaultClientScopesLoader
          ) {
            return ClientDefaultClientScopesLoader();
          },
          clientOptionalClientScopes: function (
      ...
      .when("/realms/:realm/client-scopes/:clientScope/mappers/:id", {
        templateUrl:
          resourceUrl + "/partials/client-scope-protocol-mapper-detail.html",
        resolve: {
          realm: function (RealmLoader) {
            return RealmLoader();
          },
      ...
      .when(
        ...
        {
          templateUrl:
            resourceUrl + "/partials/client-credentials-jwt-key-import.html",
          resolve: {
            realm: function (RealmLoader) {
              return RealmLoader();
            },
      ...
      .when(
        ...
        {
          templateUrl:
            resourceUrl + "/partials/client-credentials-jwt-key-export.html",
          resolve: {
            realm: function (RealmLoader) {
              return RealmLoader();
            },
      ...
      .when("/realms/:realm/clients/:client/service-account-roles", {
        templateUrl:
          resourceUrl + "/partials/client-service-account-roles.html",
        resolve: {
          realm: function (RealmLoader) {
            return RealmLoader();
          },
      ...
      .when("/realms/:realm/default-client-scopes", {
        ...
        resolve: {
          ...
          realmOptionalClientScopes: function (
      ...
      .when("/create/ldap-mappers/:realm/:componentId", {
        ...
        resolve: {
          ...
          mapperTypes: function (SubComponentTypesLoader, $route) {
            return SubComponentTypesLoader.loadComponents(
              $route.current.params.componentId,
              "org.keycloak.storage.ldap.mappers.LDAPStorageMapper"
            );
          },
      ...
      .when("/realms/:realm/authentication/flow-bindings", {
        templateUrl:
          resourceUrl + "/partials/authentication-flow-bindings.html",
        resolve: {
          realm: function (RealmLoader) {
            return RealmLoader();
          },
      ...
      .when("/realms/:realm/authentication/required-actions", {
        ...
        resolve: {
          ...
          unregisteredRequiredActions: function (
      ...
      .when("/realms/:realm/authentication/webauthn-policy-passwordless", {
        templateUrl:
          resourceUrl + "/partials/webauthn-policy-passwordless.html",
        resolve: {
          realm: function (RealmLoader) {
            return RealmLoader();
          },
...
module.factory(
  "errorInterceptor",
  function ($q, $window, $rootScope, $location, Notifications, Auth) {
    return {
      response: function (response) {
        return response;
      },
  ...
  function (
    ...
    $scope.selectClientRole = function () {
      config[configName] =
        ...
        "." +
        $scope.selectedClientRole.role.name;
      $modalInstance.close();
    };
...
module.controller(
  "ProviderConfigCtrl",
  function ($modal, $scope, $route, ComponentUtils, Client) {
...
module.controller(
  ...
  function (
    ...
    $scope.selectClientRole = function () {
      config[configName][0] =
        $scope.client.selected.clientId +
        "." +
        $scope.selectedClientRole.role.name;
      $modalInstance.close();
    };
...
module.controller(
  "ComponentConfigCtrl",
  function ($modal, $scope, $route, Client) {
    $scope.initSelectedClient = function (configName, config) {
      if (config[configName]) {
        $scope.selectedClient = null;
        Client.query(
    ...
    $scope.openRoleSelector = function (configName, config) {
      $modal.open({
        templateUrl:
          resourceUrl + "/partials/modal/component-role-selector.html",
...
module.directive("kcTooltip", function ($compile) {
  return {
    ...
    link: function link(scope, element, attrs) {
      ...
      label.append(
        ' <i class="fa fa-question-circle text-muted" tooltip="' +
          tooltip +
          '" tooltip-placement="right" tooltip-trigger="mouseover mouseout"></i>'
      );

...
public class LicenseeFormRestControllerTest {

    @ClassRule
    public static PostgreSQLContainer postgreSQLContainer = BocraportalTestContainer.getInstance();

    private String path = "/licensee/form";

    protected Logger logger = LoggerFactory.getLogger(LicenseeFormRestControllerTest.class);
    ...
    @Autowired
    private LicenseeFormRestController licenseeFormRestController;

    @Autowired
    protected LicenseeFormService licenseeFormService;

...
public class MenuSectionRestControllerTest {

    @ClassRule
    public static PostgreSQLContainer postgreSQLContainer = BocraportalTestContainer.getInstance();

    private String path = "/menu/section";

    protected Logger logger = LoggerFactory.getLogger(MenuSectionRestControllerTest.class);
    ...
    @Autowired
    private MenuSectionRestController menuSectionRestController;
    ...
    @Test
    public void findByAuthorisationRoles() {

...
public class FormFieldRestControllerTest {

    @ClassRule
    public static PostgreSQLContainer postgreSQLContainer = BocraportalTestContainer.getInstance();

    private String path = "/form/field";

    protected Logger logger = LoggerFactory.getLogger(FormFieldRestControllerTest.class);

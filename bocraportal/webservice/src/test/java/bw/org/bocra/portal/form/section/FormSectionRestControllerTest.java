...
public class FormSectionRestControllerTest {

    @ClassRule
    public static PostgreSQLContainer postgreSQLContainer = BocraportalTestContainer.getInstance();

    private String path = "/form/section";

    protected Logger logger = LoggerFactory.getLogger(FormSectionRestControllerTest.class);
    ...
    @Autowired
    protected FormSectionService formSectionService;

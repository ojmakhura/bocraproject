...
public class ContactMessageRestControllerTest {
    ...
    protected Logger logger = LoggerFactory.getLogger(ContactMessageRestControllerTest.class);
    ...
    @Autowired
    private ContactMessageRestController contactMessageRestController;

...
public class LicenseeSectorRestControllerTest {

    @ClassRule
    public static PostgreSQLContainer postgreSQLContainer = BocraportalTestContainer.getInstance();

    private String path = "/licensee/sector";

    protected Logger logger = LoggerFactory.getLogger(LicenseeSectorRestControllerTest.class);
    ...
    @Autowired
    private LicenseeSectorRestController licenseeSectorRestController;

    @Autowired
    protected LicenseeSectorService licenseeSectorService;

...
public class ReportConfigRestControllerTest {

    @ClassRule
    public static PostgreSQLContainer postgreSQLContainer = BocraportalTestContainer.getInstance();

    private String path = "/report/config";

    protected Logger logger = LoggerFactory.getLogger(ReportConfigRestControllerTest.class);
    ...
    @Autowired
    private ReportConfigRestController reportConfigRestController;

...
public class NoteRestControllerTest {
    ...
    private String path = "/form/submission/note";

    protected Logger logger = LoggerFactory.getLogger(NoteRestControllerTest.class);
    ...
    @WithMockUser(username = "testuser4", password = "testuser1")
    @Test
    public void getFormSubmissionNotes() {

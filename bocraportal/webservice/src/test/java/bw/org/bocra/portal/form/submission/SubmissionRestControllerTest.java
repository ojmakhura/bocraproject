...
public class SubmissionRestControllerTest {
    ...
    private String path = "/form/submission";

    protected Logger logger = LoggerFactory.getLogger(SubmissionRestControllerTest.class);
    ...
    @WithMockUser(username = "testuser4", password = "testuser1")
    @Test
    public void getSubmissionSummary() {

    }

    @WithMockUser(username = "testuser4", password = "testuser1")
    @Test
    public void loadDueSubmissions() {

...
@RestController
@RequestMapping("period/instance")
@CrossOrigin()
public class PeriodInstanceRestControllerImpl extends PeriodInstanceRestControllerBase {

    protected static Logger log = LoggerFactory.getLogger(PeriodInstanceRestControllerImpl.class);

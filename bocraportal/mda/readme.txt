    ...
    that a model called 'bocraportal' has been created within your Magic Draw model.

    Important: before launching AndroMDA, be sure to have exported your model.

    /bocraportal J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (*nix)
        /home/Onalenna J. Makhura/.m2/repository/bocraportal/

...
export class LicenceEffects {
  ...
  findById$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ id }) =>
        this.licenceRestController.findById(id).pipe(
          map((licence) =>
            LicenceActions.findByIdSuccess({
              licence,
              messages: [`Licence ${licence.licenceNumber} found.`],
              success: true,
            })
          ),
          catchError(({ error }) => [LicenceActions.licenceFailure({ messages: [error?.error ? error.error : error] })])
        )
      )
    )
  );
  ...
  save$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ licence }) =>
        this.licenceRestController.save(licence).pipe(
          map((licence) =>
            LicenceActions.saveSuccess({
              licence,
  ...
  remove$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ id }) =>
        this.licenceRestController.remove(id).pipe(
          map((removed) =>
            LicenceActions.removeSuccess({
              removed,
  ...
  getAll$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(() =>
        this.licenceRestController.getAll().pipe(
          map((licences) =>
            LicenceActions.getAllSuccess({
              licences,
  ...
  search$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ criteria }) =>
        this.licenceRestController.search(criteria).pipe(
          map((licences) =>
            LicenceActions.searchSuccess({
              licences,
              messages: [`${licences.length} licences found.`],
              success: true,
            })
  ...
  getAllPaged$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ pageNumber, pageSize }) =>
        this.licenceRestController.getAllPaged(pageNumber, pageSize).pipe(
          map((licences) =>
            LicenceActions.getAllPagedSuccess({
              licences,
  ...
  addDocument$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ id, documentTypeId, file, fileName }) =>
        this.licenceRestController.addDocument(id, documentTypeId, file, fileName).pipe(
          map((document) =>
            LicenceActions.addDocumentSuccess({
              document,

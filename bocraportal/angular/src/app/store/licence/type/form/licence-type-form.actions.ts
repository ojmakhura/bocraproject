...
import { LicenceTypeFormVO } from '@model/bw/org/bocra/portal/licence/type/licence-type-form-vo';
...
export enum LicenceTypeFormActionType {
  ...
  FIND_BY_LICENSEE = '[Licence Form Form] Find By Licence Form',
  FIND_BY_LICENSEE_SUCCESS = '[Licence Form Form] Find By Licence Form Success',
...
export const findById = createAction(LicenceTypeFormActionType.FIND_BY_ID, props<{ id: number | any; loading: boolean }>());
...
export const findByLicenceType = createAction(
  LicenceTypeFormActionType.FIND_BY_LICENSEE,
  props<{ licenceTypeId: number | any; loading: boolean }>()
);

export const findByLicenceTypeSuccess = createAction(
  LicenceTypeFormActionType.FIND_BY_LICENSEE_SUCCESS,
...
export const create = createAction(
  ...
  props<{ licenceTypeId: number; formId: number; loading: boolean }>()
);
...
export const updateLicenceType = createAction(
  ...
  props<{ id: number; licenceTypeId: number; loading: boolean }>()
);
...
export const remove = createAction(LicenceTypeFormActionType.REMOVE, props<{ id: number | any; loading: boolean }>());
...
export const getAll = createAction(LicenceTypeFormActionType.GET_ALL, props<{ loading: boolean }>());

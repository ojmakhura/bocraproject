...
export class LicenceTypeEffects {
  ...
  findById$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ id }) =>
        this.licenceTypeRestController.findById(id).pipe(
          map((licenceType) =>
            LicenceTypeActions.findByIdSuccess({
              licenceType,
          ...
          catchError(({ error }) => [
            LicenceTypeActions.licenceTypeFailure({ messages: [error?.error ? error.error : error] }),
          ])
        )
      )
    )
  ...
  save$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ licenceType }) =>
        this.licenceTypeRestController.save(licenceType).pipe(
          map((licenceType) =>
            LicenceTypeActions.saveSuccess({
              licenceType,
  ...
  remove$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ id }) =>
        this.licenceTypeRestController.remove(id).pipe(
          map((removed) =>
            LicenceTypeActions.removeSuccess({
              removed,
  ...
  getAll$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(() =>
        this.licenceTypeRestController.getAll().pipe(
          map((licenceTypes) =>
            LicenceTypeActions.getAllSuccess({
              licenceTypes,
  ...
  search$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ criteria }) =>
        this.licenceTypeRestController.search(criteria).pipe(
          map((licenceTypes) =>
            LicenceTypeActions.searchSuccess({
              licenceTypes,
              messages: [`${licenceTypes.length} licence types found.`],
              success: true,
            })
  ...
  getAllPaged$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ pageNumber, pageSize }) =>
        this.licenceTypeRestController.getAllPaged(pageNumber, pageSize).pipe(
          map((licenceTypes) =>
            LicenceTypeActions.getAllPagedSuccess({
              licenceTypes,

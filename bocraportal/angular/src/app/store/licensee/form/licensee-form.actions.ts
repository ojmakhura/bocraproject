...
export const findById = createAction(LicenseeActionType.FIND_BY_ID, props<{ id: number | any; loading: boolean }>());
...
export const remove = createAction(LicenseeActionType.REMOVE, props<{ id: number | any; loading: boolean }>());
...
export const getAll = createAction(LicenseeActionType.GET_ALL, props<{ loading: boolean }>());
...
export const licenseeFormFailure = createAction(LicenseeActionType.LICENSEE_FORM_FAILURE, props<{ messages: any[] }>());

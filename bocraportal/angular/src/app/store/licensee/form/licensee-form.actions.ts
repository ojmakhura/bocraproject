...
export const findById = createAction(LicenseeFormActionType.FIND_BY_ID, props<{ id: number | any; loading: boolean, loaderMessage: string | undefined }>());
...
export const remove = createAction(LicenseeFormActionType.REMOVE, props<{ id: number | any; loading: boolean, loaderMessage: string | undefined }>());
...
export const getAll = createAction(LicenseeFormActionType.GET_ALL, props<{ loading: boolean, loaderMessage: string | undefined }>());

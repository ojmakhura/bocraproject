...
export class LicenseeEffects {
  ...
  findById$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ id }) =>
        this.licenseeRestController.findById(id).pipe(
          map((licensee) =>
            LicenseeActions.findByIdSuccess({
              licensee,
          ...
          catchError(({ error }) => [
            LicenseeActions.licenseeFailure({ messages: [error?.error ? error.error : error] }),
          ])
        )
      )
    )
  ...
  save$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ licensee }) =>
        this.licenseeRestController.save(licensee).pipe(
          map((licensee) =>
            LicenseeActions.saveSuccess({
              licensee,
  ...
  remove$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ id }) =>
        this.licenseeRestController.remove(id).pipe(
          map((removed) =>
            LicenseeActions.removeSuccess({
              removed,
  ...
  getAll$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(() =>
        this.licenseeRestController.getAll().pipe(
          map((licensees) =>
            LicenseeActions.getAllSuccess({
              licensees,
  ...
  search$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ criteria }) =>
        this.licenseeRestController.search(criteria).pipe(
          map((licensees) =>
            LicenseeActions.searchSuccess({
              licensees,
              messages: [`${licensees.length} licensees found.`],
              success: true,
            })
  ...
  getAllPaged$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ pageNumber, pageSize }) =>
        this.licenseeRestController.getAllPaged(pageNumber, pageSize).pipe(
          map((licensees) =>
            LicenseeActions.getAllPagedSuccess({
              licensees,
  ...
  addDocument$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ id, documentTypeId, file, fileName }) =>
        this.licenseeRestController.addDocument(id, documentTypeId, file, fileName).pipe(
          map((document) =>
            LicenseeActions.addDocumentSuccess({
              document,

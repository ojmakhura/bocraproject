...
export const findById = createAction(LicenseeSectorActionType.FIND_BY_ID, props<{ id: number | any; loading: boolean, loaderMesage: string | undefined }>());
...
export const create = createAction(
  ...
  props<{ licenseeId: number; sectorId: number; loading: boolean, loaderMesage: string | undefined }>()
);
...
export const remove = createAction(LicenseeSectorActionType.REMOVE, props<{ id: number | any; loading: boolean, loaderMesage: string | undefined }>());
...
export const getAll = createAction(LicenseeSectorActionType.GET_ALL, props<{ loading: boolean, loaderMesage: string | undefined }>());

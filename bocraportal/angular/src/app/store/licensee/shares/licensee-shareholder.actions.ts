...
import { LicenseeShareholderVO } from '@model/bw/org/bocra/portal/licensee/shares/licensee-LicenseeShareholderVO-vo';
...
export enum LicenseeShareholderActionType {
  ...
  FIND_BY_SHAREHOLDER = '[Licensee Shareholder] Find By Sector',
  FIND_BY_SHAREHOLDER_SUCCESS = '[Licensee Shareholder] Find By Sector Success',
  ...
  UPDATE_SHAREHOLDER = '[Licensee Shareholder] Update Sector',
...
export const findByIdSuccess = createAction(
  ...
  props<{ licenseeSector: LicenseeShareholderVO | any; messages: any[]; success: boolean }>()
);
...
export const findByLicenseeSuccess = createAction(
  ...
  props<{ licenseeSectors: LicenseeShareholderVO[] | any[]; messages: any[]; success: boolean }>()
);
...
export const licenseeSectorReset = createAction(LicenseeShareholderActionType.LICENSEE_SHAREHOLDER_RESET);
...
export const licenseeSectorFailure = createAction(LicenseeShareholderActionType.LICENSEE_SHAREHOLDER_FAILURE, props<{ messages: any[] }>());

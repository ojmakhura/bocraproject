...
export const save = createAction(
  ...
  props<{ accessPointType: AccessPointTypeVO | any; loading: boolean }>()
);
...
export const remove = createAction(AccessPointTypeActionType.REMOVE, props<{ id: number | any; loading: boolean }>());
...
export const getAll = createAction(AccessPointTypeActionType.GET_ALL, props<{ loading: boolean }>());

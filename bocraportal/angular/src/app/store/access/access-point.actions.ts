...
export const findById = createAction(AccessPointActionType.FIND_BY_ID, props<{ id: number | any; loading: boolean, loaderMesage: string | undefined }>());
...
export const save = createAction(
  ...
  props<{ accessPoint: AccessPointVO | any; loading: boolean, loaderMesage: string | undefined }>()
);
...
export const remove = createAction(AccessPointActionType.REMOVE, props<{ id: number | any; loading: boolean, loaderMesage: string | undefined }>());
...
export const getAll = createAction(AccessPointActionType.GET_ALL, props<{ loading: boolean, loaderMesage: string | undefined }>());
...
export const search = createAction(
  ...
  props<{ criteria: AccessPointCriteria | any; loading: boolean, loaderMesage: string | undefined }>()
);
...
export const pagedSearch = createAction(
  ...
  props<{ pageNumber: number | any; pageSize: number | any; criteria: AccessPointCriteria | any; loading: boolean, loaderMesage: string | undefined }>()
);

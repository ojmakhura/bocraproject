...
export const setSections = createAction(FormActionType.SET_SECTIONS, props<{ formSections: FormSectionVO[] }>());
...
export const setLicensees = createAction(FormActionType.SET_LICENSEES, props<{ licenseeForms: LicenseeFormVO[] }>());
...
export const formFailure = createAction(FormActionType.FORM_FAILURE, props<{ messages: any[] }>());

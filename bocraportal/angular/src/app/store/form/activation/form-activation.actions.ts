...
export const save = createAction(
    ...
    props<{ formActivation: FormActivationVO | any , loading: boolean, loaderMesage: string | undefined }>()
);
...
export const search = createAction(
    ...
    props<{ criteria: FormActivationCriteria | any , loading: boolean, loaderMesage: string | undefined }>()
);

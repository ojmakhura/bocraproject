...
export const formActivationReducer = createReducer(
  ...
  on(FormActivationActions.createMissingSubmissions, (state, action) => ({
    ...state,
    loading: action.loading,
    loaderMessage: action.loaderMessage,
  })),
  on(FormActivationActions.createMissingSubmissionsSuccess, (state, action) => ({
    ...state,
  ...
  on(FormActivationActions.recreateActivationSubmissions, (state, action) => ({
    ...state,
    loading: action.loading,
    loaderMessage: action.loaderMessage,
  })),
  on(FormActivationActions.recreateActivationSubmissionsSuccess, (state, action) => ({
    ...state,
    formSubmissions: action.formSubmissions,
    loading: false,
    loaderMessage: undefined,

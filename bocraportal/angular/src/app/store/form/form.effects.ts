...
export class FormEffects {
    ...
    this.actions$.pipe(
      ...
      mergeMap(({ id }) =>
        this.formRestController.findById(id).pipe(
          map((form) =>
            FormActions.findFormByIdSuccess({
              form,
    ...
    this.actions$.pipe(
      ...
      mergeMap(() =>
        this.formRestController.getAll().pipe(
          map((forms) =>
            FormActions.getAllFormsSuccess({
              forms,
    ...
    this.actions$.pipe(
      ...
      mergeMap(({ criteria }) =>
        this.formRestController.search(criteria).pipe(
          map((forms) =>
            FormActions.searchFormsSuccess({
              forms,
              messages: [`${forms.length} forms found.`],
              success: true,
            })
    ...
    this.actions$.pipe(
      ...
      mergeMap(({ pageNumber, pageSize }) =>
        this.formRestController.getAllPaged(pageNumber, pageSize).pipe(
          map((forms) =>
            FormActions.getAllFormsPagedSuccess({
              forms,
  ...
  findFieldById$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ id }) =>
        this.formFieldRestController.findById(id).pipe(
          map((formField) =>
            FormActions.findFieldByIdSuccess({
              formField,
  ...
  saveField$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ formField }) =>
        this.formFieldRestController.save(formField).pipe(
          map((formField) =>
            FormActions.saveFieldSuccess({
              formField,
  ...
  saveSection$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ formSection }) =>
        this.formSectionRestController.save(formSection).pipe(
          map((formSection) =>
            FormActions.saveSectionSuccess({
              formSection,
  ...
  removeSection$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ id }) =>
        this.formSectionRestController.remove(id).pipe(
          map((removed) =>
            FormActions.removeSectionSuccess({
              removed,
  ...
  removeField$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ id }) =>
        this.formFieldRestController.remove(id).pipe(
          map((removed) =>
            FormActions.removeFieldSuccess({
              removed,
  ...
  getAllFields$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(() =>
        this.formFieldRestController.getAll().pipe(
          map((formFields) =>
            FormActions.getAllFieldsSuccess({
              formFields,
  ...
  getAllFieldsPaged$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ pageNumber, pageSize }) =>
        this.formFieldRestController.getAllPaged(pageNumber, pageSize).pipe(
          map((formFields) =>
            FormActions.getAllFieldsPagedSuccess({
              formFields,

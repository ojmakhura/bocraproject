...
export const save = createAction(
    ...
    props<{ authorisation: AuthorisationVO | any , loading: boolean, loaderMesage: string | undefined }>()
);
...
export const search = createAction(
    ...
    props<{ criteria: AuthorisationCriteria | any, loading: boolean, loaderMesage: string | undefined }>()
);
...
export const assignMenuSection = createAction(
    ...
    props<{ authorisationId: number, menuSectionId: number, loading: boolean, loaderMesage: string | undefined }>()
);

...
export const save = createAction(
    ...
    props<{ menuSection: MenuSectionVO | any , loading: boolean, loaderMesage: string | undefined }>()
);
...
export const findByAuthorisationRoles = createAction(
    ...
    props<{ roles: Set<string> | any , loading: boolean, loaderMesage: string | undefined }>()
);

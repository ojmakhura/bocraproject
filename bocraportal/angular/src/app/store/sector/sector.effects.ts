...
export class SectorEffects {
  ...
  findById$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ id }) =>
        this.sectorRestController.findById(id).pipe(
          map((sector) =>
            SectorActions.findByIdSuccess({
              sector,
  ...
  save$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ sector }) =>
        this.sectorRestController.save(sector).pipe(
          map((sector) =>
            SectorActions.saveSuccess({
              sector,
  ...
  addLicensee$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ sectorId, licenseeId }) =>
        this.sectorRestController.addLicensee(sectorId, licenseeId).pipe(
          map((licensee) =>
            SectorActions.addLicenseeSuccess({
              licensee,
  ...
  remove$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ id }) =>
        this.sectorRestController.remove(id).pipe(
          map((removed) =>
            SectorActions.removeSuccess({
              removed,
  ...
  getAll$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(() =>
        this.sectorRestController.getAll().pipe(
          map((sectors) =>
            SectorActions.getAllSuccess({
              sectors,
  ...
  search$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ criteria }) =>
        this.sectorRestController.search(criteria).pipe(
          map((sectors) =>
            SectorActions.searchSuccess({
              sectors,
              messages: [`${sectors.length} sectors found.`],
              success: true,
            })
  ...
  getAllPaged$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ pageNumber, pageSize }) =>
        this.sectorRestController.getAllPaged(pageNumber, pageSize).pipe(
          map((sectors) =>

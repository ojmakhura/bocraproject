...
export const save = createAction(
    ...
    props<{ sector: SectorVO | any , loading: boolean, loaderMesage: string | undefined }>()
);
...
export const addLicensee = createAction(
    ...
    props<{ sectorId: number, licenseeId: number, loading: boolean, loaderMesage: string | undefined }>()
);

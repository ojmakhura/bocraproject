...
import { VoiceTrafficController } from '@app/controller/form/voice/voice-traffic-controller';


@Injectable()
export class VoiceTrafficControllerImpl extends VoiceTrafficController {

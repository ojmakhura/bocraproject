...
import { PeriodInstanceController } from '@app/controller/period/instance/period-instance-controller';


@Injectable()
export class PeriodInstanceControllerImpl extends PeriodInstanceController {

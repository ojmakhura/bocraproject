...
import { PeriodConfigController } from '@app/controller/period/config/period-config-controller';


@Injectable()
export class PeriodConfigControllerImpl extends PeriodConfigController {

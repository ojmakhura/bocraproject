...
import { SearchURLAuthorisationsComponent, SearchURLAuthorisationsVarsForm } from '@app/view/auth/search-authorisations.component';
import { SearchURLAuthorisationsSearchForm } from '@app/view/auth/search-authorisations.component';
...
export class SearchAuthorisationsComponentImpl extends SearchAuthorisationsComponent {
   ...
   */
  afterSetSearchURLAuthorisationsSearchForm(form: SearchURLAuthorisationsSearchForm): void {}

  /**
   * This method may be overwritten
   */
  beforeSearchURLAuthorisationsSearch(form: SearchURLAuthorisationsSearchForm): void {
   ...
   * This method may be overwritten
   */
  afterSearchURLAuthorisationsSearch(form: SearchURLAuthorisationsSearchForm): void {}

  afterSetSearchURLAuthorisationsVarsForm(form: SearchURLAuthorisationsVarsForm): void {
  }
}

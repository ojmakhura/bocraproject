...
export abstract class EditLicenseeComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  licenseeUsersColumns = ['userId', 'username', 'email', 'firstName', 'lastName'];

  licenseeUsersModalColumns = ['actions', ...this.licenseeUsersColumns];
  ...
  licenseeFormsColumns = ['id', 'code', 'formName'];

  licenseeFormsModalColumns = ['actions', 'id', 'code', 'formName'];
  ...
  licenseeLicencesColumns = ['id', 'licenceType.name', 'licenceNumber', 'startDate', 'endDate', 'status'];

  licenseeLicencesModalColumns = ['actions', ...this.licenseeLicencesColumns];
  ...
  licenseeDocumentsColumns = ['id', 'documentId', 'documentName', 'documentType.name'];
  ...
  licenseeSectorsColumns = ['id', 'code', 'name'];

  licenseeSectorsModalColumns = ['actions', ...this.licenseeSectorsColumns];
  ...
  licenseeShareholdersColumns = ['id', 'shareholder.shareholderId', 'shareholder.name', 'numberOfShares'];

  licenseeShareholdersModalColumns = ['actions', ...this.licenseeShareholdersColumns];
  ...
  ngOnInit() {
    ...
    this.editLicenseeForm.valueChanges.subscribe((change: any) => {
  ...
  createLicenseeForm(licensee: LicenseeVO): FormGroup {
    return this.formBuilder.group({
      ...
      tradingAs: [{ value: licensee?.tradingAs, disabled: false }],
      contactEmail: [{ value: licensee?.contactEmail, disabled: false }],
      contactNo: [{ value: licensee?.contactNo, disabled: false }],

...
export abstract class NewShareholderComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  shareholderDocumentsColumns = ['id', 'documentId', 'documentType.name', 'documentName'];

  shareholderDocumentsModalColumns = ['actions', ...this.shareholderDocumentsColumns];
  ...
  shareholderLicenseeModalColumns = ['actions', 'id', 'uin', 'licenseeName'];

  @ViewChild('shareholderShareholderModalPaginator', { static: true })
  shareholderShareholderModalPaginator: MatPaginator;
  ...
  shareholderShareholderModalColumns = ['actions', 'type', 'shareholderId', 'name'];
  ...
  ngOnInit() {
    ...
    this.newShareholderForm.valueChanges.subscribe((change: any) => {

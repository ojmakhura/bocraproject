...
import { EditLicenseTypeComponent } from '@app/view/type/edit-license-type.component';
import { EditLicenseTypeSaveForm } from '@app/view/type/edit-license-type.component';
import { EditLicenseTypeNewForm } from '@app/view/type/edit-license-type.component';
...
export class EditLicenseTypeComponentImpl extends EditLicenseTypeComponent {
   ...
   * This method may be overwritten
   */
  afterSetEditLicenseTypeNewForm(form: EditLicenseTypeNewForm): void {}

  /**
   * This method may be overwritten
   */
  beforeEditLicenseTypeNew(form: EditLicenseTypeNewForm): void {
    this.store.dispatch(licenseTypeActions.reset());
  }

  /**
   * This method may be overwritten
   */
  afterEditLicenseTypeNew(form: EditLicenseTypeNewForm): void {}

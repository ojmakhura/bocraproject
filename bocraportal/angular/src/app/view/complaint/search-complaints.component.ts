...
export abstract class SearchComplaintsComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  complaintsDocumentsColumns = ['id', 'documentId', 'documentType.name', 'documentName'];

  complaintsDocumentsModalColumns = ['actions', ...this.complaintsDocumentsColumns];
  ...
  complaintsComplaintRepliesColumns = ['id', 'date', 'replyUser'];

  complaintsComplaintRepliesModalColumns = ['actions', ...this.complaintsComplaintRepliesColumns];
  ...
  @ViewChild('complaintsComplaintRepliesModalPaginator', { static: true })
  complaintsComplaintRepliesModalPaginator: MatPaginator;
  ...
  @ViewChild('complaintsComplaintTypeModalPaginator', { static: true })
  complaintsComplaintTypeModalPaginator: MatPaginator;
  ...
  complaintsComplaintTypeModalColumns = ['actions', 'id', 'code', 'typeName'];
  ...
  complaintsLicenseeModalColumns = ['actions', 'id', 'uin', 'licenseeName'];
  ...
  ngOnInit() {
    ...
    this.searchComplaintsForm.valueChanges.subscribe((change: any) => {
  ...
  setSearchComplaintsVarsForm(form: SearchComplaintsVarsForm) {
    ...
    this.searchComplaintsVarsFormControl.setControl(
      'loggedInSearch',
      this.createLoggedInSearchForm(form.loggedInSearch)
    );

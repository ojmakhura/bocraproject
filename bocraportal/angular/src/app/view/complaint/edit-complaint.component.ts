...
export abstract class EditComplaintComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  complaintDocumentsColumns = ['id', 'documentId', 'documentType.name', 'documentName'];

  complaintDocumentsModalColumns = ['actions', ...this.complaintDocumentsColumns];
  ...
  complaintComplaintRepliesColumns = ['id', 'date', 'replyUser'];

  complaintComplaintRepliesModalColumns = ['actions', ...this.complaintComplaintRepliesColumns];
  ...
  @ViewChild('complaintComplaintRepliesModalPaginator', { static: true })
  complaintComplaintRepliesModalPaginator: MatPaginator;
  ...
  @ViewChild('complaintComplaintTypeModalPaginator', { static: true })
  complaintComplaintTypeModalPaginator: MatPaginator;
  ...
  complaintComplaintTypeModalColumns = ['actions', 'id', 'code', 'typeName'];
  ...
  complaintLicenseeModalColumns = ['actions', 'id', 'uin', 'licenseeName'];
  ...
  ngOnInit() {
    ...
    this.editComplaintForm.valueChanges.subscribe((change: any) => {
  ...
  licenseeUserSelected(event: MatRadioChange, data: UserVO): void {
    ...
    this.handleLicenseeUserSelected(event, data);
  }
  ...
  licenseeUserClear(): void {
    this.complaintControl.patchValue({ assignedTo: '' });
  }
}

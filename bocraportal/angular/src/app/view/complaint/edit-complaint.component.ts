...
export abstract class EditComplaintComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    licenseeUserSelect: UserVO = new UserVO();
    ...
    get complaintAssignedTo(): UserVO {
    ...
    licenseeUserSelected(event: MatRadioChange, data: UserVO): void {
        ...
        this.licenseeUserSelect = data;
        this.handleLicenseeUserSelected(event, data);
    }

    addSelectedLicenseeUser(): void {
        this.complaintControl.patchValue({ complaintAssignedTo: this.licenseeUserSelect });
    }

    licenseeUserClear(): void {
        this.complaintControl.patchValue({ complaintAssignedTo: new ComplaintTypeVO() });
    }

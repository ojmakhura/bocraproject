...
export abstract class EditSectorComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  sectorLicenseesColumns = ['id', 'uin', 'licenseeName'];

  sectorLicenseesModalColumns = ['actions', ...this.sectorLicenseesColumns];
  ...
  sectorFormsColumns = ['id', 'code', 'formName'];

  sectorFormsModalColumns = ['actions', ...this.sectorFormsColumns];
  ...
  ngOnInit() {
    ...
    this.editSectorForm.valueChanges.subscribe((change: any) => {

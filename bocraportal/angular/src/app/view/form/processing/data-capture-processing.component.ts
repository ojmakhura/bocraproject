...
export abstract class DataCaptureProcessingComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.dataCaptureProcessingForm.valueChanges.subscribe((change: any) => {
   ...
   * This method may be overwritten
   */
  afterDataCaptureProcessingOverdueSubmissions(
    form: DataCaptureProcessingOverdueSubmissionsForm,
    dialogData: any
  ): void {}
   ...
   * This method may be overwritten
   */
  afterDataCaptureProcessingReturnedSubmissions(
    form: DataCaptureProcessingReturnedSubmissionsForm,
    dialogData: any
  ): void {}
   ...
   * This method may be overwritten
   */
  afterDataCaptureProcessingAcceptedSubmissions(
    form: DataCaptureProcessingAcceptedSubmissionsForm,
    dialogData: any
  ): void {}

...
export class AccessPointTypeRestController {
    ...
    public pagedSearch(pageNumber: number | any , pageSize: number | any , criteria: AccessPointCriteria | any ): Observable<AccessPointTypeVO[] | any[]> {

        return this.http.post<AccessPointTypeVO[] | any[]>(this.path + `/search/page/${pageNumber}/size/${pageSize}`, {pageNumber: pageNumber, pageSize: pageSize, criteria: criteria});

    ...
    The project located in this directory has been generated by Lesego Nkomazana
    ...
    that a model called 'bocraproject' has been created within your Magic Draw model.

    Important: before launching AndroMDA, be sure to have exported your model.

    /bocraproject J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (*nix)
        /home/Lesego Nkomazana/.m2/repository/bocraproject/
